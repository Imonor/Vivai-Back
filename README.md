...
| getPlantId    | GET | Check if specie as completed infos. If not, it completes the plant infos by web scrapping and returns the plant id, else, it returns the plant id directly |
