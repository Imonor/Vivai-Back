...
| insertPlant       | PUT  | Insert a plant for the user | app/insertPlant | userId(string), species(string) (**REQUIRED**), location(string), temperature(string), sunExpo(string), shared(boolean) (**OPTIONAL**)  | {"userPlantId" : "19"} |
